...
class se3Logon:
    ...
    def __init__ (self, path2BatFiles, path2Templates, user, computer, master, arch, urlse3):
        ...
        try: 
            ...
            self.__logonU.write ("start /B cscript //B %SYSTEMROOT%\Printers.vbs\r\n")
            self.__logonC.write ("start /B cscript //B %SYSTEMROOT%\Printers.vbs\r\n")
    ...
    def __del__ (self):
        ...
        try:
            ...
            self.__logonU.write ("echo fin execution du logon.cmd de %USERNAME%--->> %SYSTEMDRIVE%\\netinst\\logs\\domscripts.txt\r\n")
            ...
            self.__logoffU.write ("del /Q /S /F %SYSTEMROOT%\Web\Wallpaper\*_se3.*>>%SYSTEMDRIVE%\\netinst\\logs\\domscripts.txt\r\n")
            self.__logonC.write ("cacls %SYSTEMDRIVE%\\netinst\\logs\\domscripts.txt /E /G Utilisateurs:F\r\n")
            self.__logonU.close ()
            self.__logonC.close ()
